...
public class PlaceholderFragment_Task_0409 extends Fragment {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_task_0409, container, false);


        countFile = root.findViewById(R.id.task0409_edittext_count_file);
        ...
        countMask = root.findViewById(R.id.task0409_edittext_count_mask);
        ...
        listFile = root.findViewById(R.id.task0409_list_all_file);
        listMask = root.findViewById(R.id.task0409_list_mask);


        tAnswer = root.findViewById(R.id.task0409_text_answer);

        bAnswer = root.findViewById(R.id.task0409_btn_answer);
