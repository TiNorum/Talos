 ...
 */
public class PlaceholderFragment_Task_0411 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0411 newInstance(int index) {
        PlaceholderFragment_Task_0411 fragment = new PlaceholderFragment_Task_0411();
    ...
    View.OnClickListener oclBtn = new View.OnClickListener() {
        ...
        private boolean checkData() {
            ...
            if (radioGroup.getCheckedRadioButtonId() == -1) {
                ShowTost.showTost(getContext(), "Выберите кого нужно найти!");
        ...
        private String getData() {
            ...
            String data = "100" + Constants.NEXT_LINE + 11 + Constants.NEXT_LINE;
    ...
    public class TableItem {
        ...
        public TableItem(int n, Context context, LinearLayout list, int col) {
            ...
            for (int i = 1; i <= itemCount; i++) {
                listItem.add(new PlaceholderFragment_Task_0411.TableItem.item(list, col));
            }
        }
