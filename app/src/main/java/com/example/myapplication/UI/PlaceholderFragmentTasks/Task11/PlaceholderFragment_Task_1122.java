package com.example.myapplication.UI.PlaceholderFragmentTasks.Task11;
 ...
 */
public class PlaceholderFragment_Task_1122 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_1122 newInstance(int index) {
        // юзает фрагмент
        PlaceholderFragment_Task_1122 fragment = new PlaceholderFragment_Task_1122();
