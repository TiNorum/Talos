 ...
 */
public class PlaceholderFragment_Task_0203 extends Fragment {
    ...
    public static PlaceholderFragment_Task_0203 newInstance(int index) {
        PlaceholderFragment_Task_0203 fragment = new PlaceholderFragment_Task_0203();
    ...
    View.OnClickListener oclBtn = new View.OnClickListener() {
        ...
        private String getData() {
            String data = "100" + Constants.NEXT_LINE + "3" + Constants.NEXT_LINE;
