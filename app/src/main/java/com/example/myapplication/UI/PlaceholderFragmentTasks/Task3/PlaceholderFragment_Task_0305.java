 ...
 */
public class PlaceholderFragment_Task_0305 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0305 newInstance(int index) {
        PlaceholderFragment_Task_0305 fragment = new PlaceholderFragment_Task_0305();
    ...
    View.OnClickListener oclBtn = new View.OnClickListener() {
        ...
        private String getData() {
            ...
            String data = "100" + Constants.NEXT_LINE + 5 + Constants.NEXT_LINE;
