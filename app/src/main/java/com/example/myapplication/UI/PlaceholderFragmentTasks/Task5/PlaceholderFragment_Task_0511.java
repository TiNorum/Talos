package com.example.myapplication.UI.PlaceholderFragmentTasks.Task5;
 ...
 */
public class PlaceholderFragment_Task_0511 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0511 newInstance(int index) {
        PlaceholderFragment_Task_0511 fragment = new PlaceholderFragment_Task_0511();
    ...
    View.OnClickListener oclBtn = new View.OnClickListener() {
        ...
        private String getData() {
            ...
            data += num1.getText().toString() + Constants.NEXT_LINE;
