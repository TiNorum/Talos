 ...
 */
public class PlaceholderFragment_Task_0612 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0612 newInstance(int index) {
        // юзает фрагмент
        PlaceholderFragment_Task_0612 fragment = new PlaceholderFragment_Task_0612();
