package com.example.myapplication.UI.PlaceholderFragmentTasks.Task6;
 ...
 */
public class PlaceholderFragment_Task_0613 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0613 newInstance(int index) {
        // юзает фрагмент
        PlaceholderFragment_Task_0613 fragment = new PlaceholderFragment_Task_0613();
    ...
    View.OnClickListener oclBtn = new View.OnClickListener() {
        ...
        private String getData() {
            String data = "100" + Constants.NEXT_LINE + "13" + Constants.NEXT_LINE;
