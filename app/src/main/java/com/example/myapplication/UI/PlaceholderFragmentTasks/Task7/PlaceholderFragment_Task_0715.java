package com.example.myapplication.UI.PlaceholderFragmentTasks.Task7;
...
public class PlaceholderFragment_Task_0715 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0715 newInstance(int index) {
        PlaceholderFragment_Task_0715 fragment = new PlaceholderFragment_Task_0715();
