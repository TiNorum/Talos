...
public class PlaceholderFragment_Task_0716 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0716 newInstance(int index) {
        PlaceholderFragment_Task_0716 fragment = new PlaceholderFragment_Task_0716();
