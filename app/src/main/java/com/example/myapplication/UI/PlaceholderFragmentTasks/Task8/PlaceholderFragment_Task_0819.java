 ...
 */
public class PlaceholderFragment_Task_0819 extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModel pageViewModel;

    public static PlaceholderFragment_Task_0819 newInstance(int index) {
        PlaceholderFragment_Task_0819 fragment = new PlaceholderFragment_Task_0819();
